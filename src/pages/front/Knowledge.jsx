...
const Knowledge = () => {
  ...
  const knowledgeData = [
    {
      id: 1,
      date: { year: "2026", month: "Jan", day: "1", week: "MON." },
    ...
    {
      id: 2,
      date: { year: "2026", month: "Apr", day: "4", week: "THU." },
    ...
    {
      id: 3,
      date: { year: "2026", month: "Feb", day: "2", week: "TUE." },
    ...
    {
      id: 4,
      date: { year: "2026", month: "May", day: "5", week: "FRI." },
      title: "茶葉保存須避免的五大要素",
    ...
    {
      id: 5,
      date: { year: "2026", month: "Mar", day: "3", week: "WED." },
    ...
    {
      id: 6,
      date: { year: "2026", month: "Jun", day: "6", week: "SAT." },
      title: "茶葉中的「茶多酚」",
  ...
  const DateBox = ({ date }) => (
    <div
      className='text-center pe-3 me-3 border-end border-1 border-light-subtle'
      style={{ minWidth: "75px", fontFamily: "serif" }}
    >
      ...
      <div
        className='fw-bold'
        style={{ color: "#BC9C59", fontSize: "0.85rem", letterSpacing: "1px", margin: "4px 0" }}
      >
        {date.month}
      </div>
      <div className='text-dark fw-bold lh-1' style={{ fontSize: "2.2rem" }}>
        {date.day}
      </div>
      <div className='text-secondary mt-1' style={{ fontSize: "0.75rem", letterSpacing: "1px" }}>
        {date.week}
      </div>
    </div>
  );
      ...
      <section className='container py-5 mt-20 mb-15'>
        <div className='text-center mb-4'>
          <span
            ...
            style={{ color: "#BC9C59", letterSpacing: "2px", fontSize: "0.85rem" }}
          >
            識茶知識
          </span>
      ...
      <section className='container-fluid px-0 py-5' style={{ backgroundColor: "#FCFCFC" }}>
        <div className='container'>
          <div className='row g-0'>
            {/* 左欄 */}
            <div
              className='col-12 col-lg-4 pe-lg-5 mb-5 mb-lg-0'
                  ...
                  <React.Fragment key={item.id}>
                    <div className='d-flex align-items-start'>
                      ...
                      <div className='flex-grow-1'>
                        ...
                        <p
                          className='text-secondary small lh-lg text-justify mb-4'
                        ...
                        <img
                          ...
                          style={{ height: "220px", filter: "grayscale(15%)" }}
                        />
                      </div>
                    </div>
                    {index !== array.length - 1 && (
                      <hr className='my-5' style={{ borderColor: "#E0E0E0", opacity: 0.8 }} />
                    )}
                  </React.Fragment>
                ))}
            </div>
            {/* 中欄 */}
            <div
              className='col-12 col-lg-4 px-lg-5 mb-5 mb-lg-0'
              style={{ borderRight: "1px solid #EAEAEA" }}
            >
              <div>
                {knowledgeData
      ...
      <section className='container py-5 my-md-5'>
        ...
        <div className='d-flex align-items-center justify-content-center mt-20 mb-15 pb-4'>
          <div
            ...
            style={{ height: "1px", backgroundColor: "#BC9C59", maxWidth: "250px" }}
          ></div>
          <div className='text-center px-4 px-md-5'>
            ...
            <h2
              className='display-4 text-dark mb-0'
          ...
          {exploreData.map((item, index) => (
            ...
            >
              ...
              <div className='d-flex align-items-start mb-4'>
                {/* 直排標題 */}
                <h3
                  className='fw-bold m-0 me-3 me-lg-4 pt-2'
                  style={{
              ...
              <div className='d-flex align-items-center justify-content-between ps-lg-5'>
                {/* 描述文字 */}
                <p
                  className='small lh-lg mb-0 text-justify flex-grow-1 pe-3 px-5'
                  style={{ letterSpacing: "1px" }}
                >
                  {item.desc}
                </p>
