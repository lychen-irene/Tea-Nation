      ...
      <div className="row justify-content-center">
        <div className="order-stepper">
          {steps.map((step) => (
            ...
            >
              <div
                className={`order-step-num ${currentStep >= step.num ? "order-step-num--active" : ""}`}
              >
                {step.num}
              </div>
              <span className="order-step-label-EN">{step.labelEN}</span>
              <span className="order-step-label-ZH">{step.labelZH}</span>
            </div>
          ))}
        </div>
          ...
          <form onSubmit={submitOrder}>
            <div className="mb-4">
              ...
              <input
                id="name"
                type="text"
                className="form-control border-0 bg-light py-3 px-4 shadow-sm text-center"
            ...
            <div className="mb-4">
              ...
              <input
                id="tel"
                type="tel"
                className="form-control border-0 bg-light py-3 px-4 shadow-sm text-center fw-bold"
                style={{ borderRadius: "15px" }}
            ...
            <div className="d-flex justify-content-between gap-3 mt-5">
              <button
                type="button"
                className="btn btn-outline-success flex-grow-1 py-2 fw-bold"
              ...
              <button
                type="submit"
                className="btn btn-success text-white flex-grow-1 py-2 fw-bold"
